...
public final class Luna3DView extends GLSurfaceView {
    ...
    private static final class LunaRenderer implements Renderer {
        ...
        private void regular(float t,float blink,float mouth,float sneeze,float knock,float wave,float tilt,float ears,float sway){
            oval(0,.34f,-.22f,.50f,.77f,.32f,0,0,hairMotion*.35f,SILVER); oval(-.43f,.02f,-.18f,.18f,.72f,.18f,0,0,-4+hairMotion,DARK);oval(.43f,.02f,-.18f,.18f,.72f,.18f,0,0,4+hairMotion,DARK);body(.43f,.65f,.68f,.38f);legs(false,sway);arms(false,sway,knock,wave);head(false,.62f,.48f,.32f,blink,mouth,sneeze,tilt,ears);tail(t,false,sway);}
